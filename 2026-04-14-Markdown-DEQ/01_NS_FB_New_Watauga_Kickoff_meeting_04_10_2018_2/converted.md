...
- Water Resources Plan Combine –
  Water Use Data + Hydrologic Model
- The model shall specifically be designed to predict the places, times, frequencies, and intervals at which any of the following may occur:
...
- What happens if future droughts are longer or more severe?
- What happens if we can not discharge the same percent of wastewater?
